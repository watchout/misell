...
MISELL_GENERATED_DIR="${MISELL_GENERATED_DIR:-${MISELL_DATA_DIR}/generated}"
...
mkdir -p "${MISELL_DATA_DIR}" "${MISELL_GENERATED_DIR}" "${MISELL_ASSETS_DIR}/images" "${MISELL_ASSETS_DIR}/videos" "${MISELL_LOG_DIR}" "${MISELL_CONTENT_BACKUP_DIR}"
...
MISELL_GENERATED_DIR=${MISELL_GENERATED_DIR}
...
ensure_env_setting "MISELL_GENERATED_DIR" "${MISELL_GENERATED_DIR}"
